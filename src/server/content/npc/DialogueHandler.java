...
/**
 * Anims:
 * http://www.rune-server.org/Miscellania-PS-development/rs2-server/tutorials/518991-pi-317-player-npc-facial-dialogue-expressions.html
 */
...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 620:
			...
			break;
		case 621:
			sendNpcChat4("I'm not a hundred percent sure the Imacando tribe", "exists anymore. I should think Reldo, the palace", "librarian will know; he has done a lot of", "research on the races of Miscellania-PS.", player.talkingNpc, "Squire");
			player.nextChat = 622;
			break;
		case 622:
		...
		case 1015:
			...
			break;
		case 1016:
			sendNpcChat2("This is the bank of " + Config.SERVER_NAME + ".", "We have many branches in many towns.", player.talkingNpc, "Banker");
			player.nextChat = 0;
			break;
		/**
		...
		case 1034:
			sendNpcChat1("You have been warned, you can't go back now.",
					player.talkingNpc, "Miscellania-PS Guide");
		...
		case 1059:
			...
			break;
		case 1226:
			sendNpcChat3("You currently have "+player.taskAmount+" "+player.getSlayer().getTaskName(player.slayerTask)+" to kill.", "If you would like I could give you an easier task.", "Although if I do this, you won't recieve as many points.", player.talkingNpc, "Vannaka");
			player.nextChat = 1236;
			break;
		case 1227:
			sendNpcChat1(
		...
		case 1228:
			...
			break;
		case 1229:
			sendOption4("I need a new slayer assignment.",
					"Where is my slayer task located?",
		...
		case 1231:
			sendOption2("I want to cancel my current task.",
					"I want to remove my task PERMANENTLY.");
			...
			for (Shop shop : Shop.values()) {
				if (shop != null) {
					if (shop.getNpc() == player.talkingNpc) {
						player.getShops().openShop(shop.getShop());
		...
		case 3005:
			sendNpcChat2("contains maps and helpful tips to help you on your",
					"journey.", player.talkingNpc, "Miscellania-PS Guide");
		...
		case 3006:// show tab wrentch
			...
			sendNpcChat2(
					...
					"Miscellania-PS Guide");
			player.setSidebarInterface(11, 904); // wrench
																		// tab
			player.flashSideBarIcon(-11);
		...
		case 3010:
			...
			player.chatbox(6179);
			player.getPA().createArrow(3098, 3107, player.getHeightLevel(),
					2);
			player.nextChat = 0;
			break;
		...
		case 3013: // giving bronze and tinder
			...
			player.setSidebarInterface(3, 3213);// sends
																		// interface
			player.flashSideBarIcon(-3); // flashes
																// inventory
		...
		case 3016: // firemaking done skill tab flashing now.
			...
			player.flashSideBarIcon(-1); // flashes
																// skill
			player.setSidebarInterface(1, 3917); // sets
																		// the
																		// skill
																		// tab
		...
		case 3018:
			...
			player.getPA().createArrow(3101, 3092, player.getHeightLevel(),
					2);
		...
		case 3020: // tutorial PROGRESS = 7
			...
			player.chatbox(6179);
			player.getPA().createArrow(3078, 3084, player.getHeightLevel(),
					2);
			break;
		...
		case 3026: // cooking dough
			...
			chatboxText(
					...
					"", "Cooking dough");
			player.chatbox(6179);
			player.getPA().createArrow(3075, 3081, player.getHeightLevel(),
					2);
		...
		case 3037: // new tutorial prog
			...
			player.setSidebarInterface(13, 962); // sets
																		// music
			player.flashSideBarIcon(-13);
		...
		case 3038: // Emotes
			...
			// // 25 percent now
			player.setSidebarInterface(12, 147); // run
																		// tab
			player.flashSideBarIcon(-12);
			player.nextChat = 0;
			break;
		case 3039: // running
			...
			player.chatbox(6179);
			player.flashSideBarIcon(-12);
			player.getPA().createArrow(3086, 3126, player.getHeightLevel(),
					2);
			player.nextChat = 0;
			break;
		case 3040:
		...
		case 3041: // clicked on run
			...
			player.chatbox(6179);
			player.getPA().createArrow(3086, 3125, player.getHeightLevel(),
					2);
		...
		case 3042: // entering the quest GUIDE
			player.getPA().createArrow(1, 4); // sends to
															// quest
															// guide
		...
		case 3044: // Send quest tab
			...
			chatboxText(player, "Open the Quest Journal.", "",
					...
					"");
			player.chatbox(6179);
			player.setSidebarInterface(2, 638); // quest
			player.flashSideBarIcon(-2);
			player.nextChat = 0;
			break;
		...
		case 3050: // moving on. Cave time biaches
			...
			player.chatbox(6179);
			player.getPA().createArrow(3088, 3119, player.getHeightLevel(),
					2);
			player.nextChat = 0;
		...
		case 3055: // prospecting
			...
			player.chatbox(6179);
			// client.getPacketDispatcher().tutorialIslandInterface(40,9);
			player.getPA().createArrow(3076, 9504, player.getHeightLevel(),
					2);
			player.nextChat = 0;
		...
		case 3065: // giving you the hammer
			...
			player.getPA().createArrow(3082, 9499, player.getHeightLevel(), 2); // send
						// hint
						// to
						// furnace
			break;
		...
		case 3066:
			...
			player.getPA().createArrow(3094, 9503, player.getHeightLevel(), 2); // send
						// hint
						// to
						// furnace
			break;
		...
		case 3071: // send wear interface
			...
			chatboxText(
					...
					"", "Wielding weapons");
			player.chatbox(6179);
			player.setSidebarInterface(4, 1644);// worn
			player.flashSideBarIcon(-4);
			player.nextChat = 0;
			break;
		...
		case 3077: // gives me bow and arrow
			...
			player.getPA().drawHeadicon(1, 13, 0, 0); // draws
																	// headicon
																	// to
																	// rat
			break;
		...
		case 3078: // fresh
			...
			player.chatbox(6179);
			player.getPA().createArrow(3122, 3124, player.getHeightLevel(),
					2);
			break;
		...
		case 3088: // end
			...
			chatboxText(player, "", "Continue through the next door.", "", "",
					"");
			player.chatbox(6179);
			player.getPA().createArrow(3129, 3124, player.getHeightLevel(),
					2);
			player.getPA().createArrow(1, 8);
			player.nextChat = 0;
			break;
		// end of FINANCIAL
		...
		case 3109:
			...
			// "left. Walk over to the caged chickens, click the Wind Strike icon",
			// "and then select one of the chicken to cast it on.");
			player.getPA().drawHeadicon(1, 20, 0, 0); // draws
																	// headicon
																	// to
																	// chicken
			break;
		...
		case 3199:
			...
			case 5400:
				sendNpcChat2("Hello!", "Which game mode would you like to play?", player.talkingNpc, "Lumbridge Guide");
				player.nextChat = 5401;
				break;
			case 5401:
				sendOption4("Normal", "Iron man", "Hardcore iron man", "Ultimate iron man");
				player.dialogueAction = 13;
			break;
			case 5402:
				sendNpcChat1("Come see me if you need help!", player.talkingNpc, "Lumbridge Guide");
