		...
		while(EndOfFile == false && line != null) {
			...
			if (spot > -1) {
				...
				case 2:
					if (token.equals("character-height")) {
					...
					} else if (token.equals("character-crown")) {
						p.crown = Integer.parseInt(token2);
					} else if (token.equals("game-mode")) {
						...
						p.SlayerMaster = Integer.parseInt(token2);
						...
						p.needsNewTask = Boolean.parseBoolean(token2);
						...
						p.dPoints = Integer.parseInt(token2);
					} else if (token.equals("achvPoints")) {
						p.achvPoints = Integer.parseInt(token2);
					} else if (token.equals("loyaltyPoints")) {
						p.loyaltyPoints = Integer.parseInt(token2);
					} else if (token.equals("clue-level1")) {
						p.level1 = Integer.parseInt(token2);
					} else if (token.equals("clue-level2")) {
						p.level2 = Integer.parseInt(token2);
					} else if (token.equals("clue-level3")) {
						p.level3 = Integer.parseInt(token2);
						...
						p.hasPaid = Boolean.parseBoolean(token2);
	...
	**/
	public static boolean saveGame(Client p) {
		...
		try {
			...
			characterfile.newLine();
			characterfile.write("character-crown = ", 0, 18);
			characterfile.write(Integer.toString(p.crown), 0, Integer.toString(p.crown).length());
			characterfile.newLine();
			characterfile.write("game-mode = ", 0, 12);
			...
			characterfile.write(Integer.toString(p.dPoints), 0, Integer.toString(p.dPoints).length());
			characterfile.newLine();
			characterfile.write("achvPoints = ", 0, 13);
			characterfile.write(Integer.toString(p.achvPoints), 0, Integer.toString(p.achvPoints).length());
			characterfile.newLine();
			...
			characterfile.write(Integer.toString(p.SlayerMaster), 0, Integer.toString(p.SlayerMaster).length());
			characterfile.newLine();
			characterfile.write("needsNewTask = ", 0, 15);
			characterfile.write(Boolean.toString(p.needsNewTask), 0, Boolean.toString(p.needsNewTask).length());
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("clue-level1 = ", 0, 14);
			characterfile.write(Integer.toString(p.level1), 0, Integer.toString(p.level1).length());
			characterfile.newLine();
			characterfile.write("clue-level2 = ", 0, 14);
			characterfile.write(Integer.toString(p.level2), 0, Integer.toString(p.level2).length());
			characterfile.newLine();
			characterfile.write("clue-level3 = ", 0, 14);
			characterfile.write(Integer.toString(p.level3), 0, Integer.toString(p.level3).length());
			characterfile.newLine();
			...
			characterfile.write(Boolean.toString(p.hasPaid), 0, Boolean.toString(p.hasPaid).length());
			characterfile.newLine();
			for (int i = 0; i < p.removedTasks.length; i++) {
				characterfile.write("removedTask" + i + " = ", 0, 15);
				characterfile.write(Integer.toString(p.removedTasks[i]),
						0, Integer.toString(p.removedTasks[i]).length());
				characterfile.newLine();
			}
			characterfile.write("music = ", 0, 8);
			String music = "";
			for (boolean element : p.getPlayList().unlocked) {
				music += element + "\t";
			}
			...
			characterfile.write(Integer.toString(p.lastH), 0, Integer.toString(p.lastH).length());
			characterfile.newLine();
